// This code was modified by ArthurOudini to work from an N64 controller to an N64 console in order to act on joystick range. 
//n64-dev
...
//#include "ESS.hpp" // I will not need this I think
//#include "extra.hpp" // I will not need to use this I think
#include "input-display.hpp"


//Options
//#define GAMECUBE_CONTROLLER
#define N64_CONTROLLER  
...
CN64Console console(CONS_PIN); // Sets D8 on arduino to write data to Console.
N64_Data_t data = defaultN64Data;



// Maybe I don't need this paragraph but I am not sure.
...
void loop() {
  ...
  controller.read();
  N64_report.xAxis *= 1.2; //apply a modification to joystick's X range
  N64_report.yAxis *= 1.2; //apply a modification to joystick's Y range
  ...
  // Not trying to make the input display work for now
  //#ifdef INPUT_DISPLAY
